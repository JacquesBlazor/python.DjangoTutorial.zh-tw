...
現在，打開 `mysite/settings.py`{.file .docutils .literal .notranslate}
...
，然後改變設定文件中 [`DATABASES`{.xref .std .std-setting .docutils
.literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-DATABASES)
`'default'`{.docutils .literal .notranslate} 專案中的一些鍵值：

-   [`ENGINE`{.xref .std .std-setting .docutils .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-DATABASE-ENGINE)
    -- 可選值有 `'django.db.backends.sqlite3'`{.docutils .literal
    .notranslate}，`'django.db.backends.postgresql'`{.docutils .literal
    .notranslate}，`'django.db.backends.mysql'`{.docutils .literal
    .notranslate}，或 `'django.db.backends.oracle'`{.docutils .literal
    .notranslate}。其它
    [可使用的後端資料庫](https://docs.djangoproject.com/zh-hans/3.0/ref/databases/#third-party-notes)。
-   [`NAME`{.xref .std .std-setting .docutils .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-NAME)
    - 資料庫的名稱。如果使用的是
    SQLite，資料庫將是你電腦上的一個文件，在這種情況下， [`NAME`{.xref
    .std .std-setting .docutils .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-NAME)
    應該是此文件的絕對路徑，包括文件名稱。預設值
    `os.path.join(BASE_DIR, 'db.sqlite3')`{.docutils .literal
    .notranslate} 將會把資料庫文件儲存在專案的根目錄。

如果你不使用 SQLite，則必須增加一些額外設定，例如 [`USER`{.xref .std
.std-setting .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-USER)
、 [`PASSWORD`{.xref .std .std-setting .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-PASSWORD)
、 [`HOST`{.xref .std .std-setting .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-HOST)
等等。想了解更多資料庫設定方面的內容，請參考文件：[`DATABASES`{.xref
.std .std-setting .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-DATABASES)
。
...
"`CREATE DATABASE database_name;`{.docutils .literal .notranslate}"
命令來完成這件事。

另外，還要確保該資料庫用戶中提供 `mysite/settings.py`{.file .docutils
.literal .notranslate} 具有 "create database" 權限。這使得自動建立的
[test
...
編輯 `mysite/settings.py`{.file .docutils .literal .notranslate}
文件前，先設定 [`TIME_ZONE`{.xref .std .std-setting .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-TIME_ZONE)
為你自己時區。

此外，說明一下文件頂部的 [`INSTALLED_APPS`{.xref .std .std-setting
.docutils .literal
...
通常， [`INSTALLED_APPS`{.xref .std .std-setting .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-INSTALLED_APPS)
預設包括了以下 Django 的內建應用：

-   [`django.contrib.admin`{.xref .py .py-mod .docutils .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/contrib/admin/#module-django.contrib.admin "django.contrib.admin: Django's admin site.")
    -- 管理員網站， 你很快就會使用它。
-   [`django.contrib.auth`{.xref .py .py-mod .docutils .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/topics/auth/#module-django.contrib.auth "django.contrib.auth: Django's authentication framework.")
    -- 認證授權系統。
-   [`django.contrib.contenttypes`{.xref .py .py-mod .docutils .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/contrib/contenttypes/#module-django.contrib.contenttypes "django.contrib.contenttypes: Provides generic interface to installed models.")
    -- 內容類型框架。
-   [`django.contrib.sessions`{.xref .py .py-mod .docutils .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/topics/http/sessions/#module-django.contrib.sessions "django.contrib.sessions: Provides session management for Django projects.")
    -- 會議框架。
-   [`django.contrib.messages`{.xref .py .py-mod .docutils .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/contrib/messages/#module-django.contrib.messages "django.contrib.messages: Provides cookie- and session-based temporary message storage.")
    -- 訊息框架。
-   [`django.contrib.staticfiles`{.xref .py .py-mod .docutils .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/contrib/staticfiles/#module-django.contrib.staticfiles "django.contrib.staticfiles: An app for handling static files.")
    -- 管理靜態文件的框架。
...
這個 [`migrate`{.xref .std .std-djadmin .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/django-admin/#django-admin-migrate)
命令檢查 [`INSTALLED_APPS`{.xref .std .std-setting .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-INSTALLED_APPS)
設定，為其中的每個應用程式建立需要的資料表，至於具體會建立什麼，這取決於你的
`mysite/settings.py`{.file .docutils .literal .notranslate}
設定文件和每個應用程式的資料庫遷移文件（我們稍後會介紹這個）。這個命令所執行的每個遷移操作都會在終端中顯示出來。如果你感興趣的話，執行你資料庫的命令欄工具，並輸入
`\dt`{.docutils .literal .notranslate} (PostgreSQL)，
`SHOW TABLES;`{.docutils .literal .notranslate} (MariaDB,MySQL)，
`.schema`{.docutils .literal .notranslate} (SQLite)或者
`SELECT TABLE_NAME FROM USER_TABLES;`{.docutils .literal .notranslate}
(Oracle) 來看看 Django 到底建立了哪些表。

寫給極簡主義者

就像之前說的，為了方便大多數專案，我們預設啟用了一些應用程式，但並不是每個人都需要它們。如果你不需要某個或某些應用程式，你可以在執行
[`migrate`{.xref .std .std-djadmin .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/django-admin/#django-admin-migrate)
前毫無顧慮地從 [`INSTALLED_APPS`{.xref .std .std-setting .docutils
.literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-INSTALLED_APPS)
裡注釋或者刪除掉它們。 [`migrate`{.xref .std .std-djadmin .docutils
.literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/django-admin/#django-admin-migrate)
命令只會為在 [`INSTALLED_APPS`{.xref .std .std-setting .docutils
.literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-INSTALLED_APPS)
裡聲明了的應用程式進行資料庫遷移。
...
在這個投票應用程式中，需要建立兩個模型：問題 `Question`{.docutils
.literal .notranslate} 和選項 `Choice`{.docutils .literal
.notranslate}。`Question`{.docutils .literal .notranslate}
模型包括問題描述和發佈時間。`Choice`{.docutils .literal .notranslate}
模型有兩個欄位，選項描述和當前得票數。每個選項屬於一個問題。

這些概念可以透過一個 Python 類別來描述。按照下面的例子來編輯
`polls/models.py`{.file .docutils .literal .notranslate} 文件：
...
每個模型被表示為 [`django.db.models.Model`{.xref .py .py-class .docutils
.literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/instances/#django.db.models.Model "django.db.models.Model")
類別的子類別。每個模型有許多類別變數，它們都表示模型裡的一個資料庫欄位。

每個欄位都是 [`Field`{.xref .py .py-class .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/fields/#django.db.models.Field "django.db.models.Field")
類別的實例 - 例如，字串欄位被表示為 [`CharField`{.xref .py .py-class
.docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/fields/#django.db.models.CharField "django.db.models.CharField")
，日期時間欄位被表示為 [`DateTimeField`{.xref .py .py-class .docutils
.literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/fields/#django.db.models.DateTimeField "django.db.models.DateTimeField")
。這將告訴 Django 每個欄位要處理的資料類型。

每個 [`Field`{.xref .py .py-class .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/fields/#django.db.models.Field "django.db.models.Field")
類別實例變數的名字（例如 `question_text`{.docutils .literal
.notranslate} 或 `pub_date`{.docutils .literal .notranslate}
）也是欄位名稱，所以最好使用對機器友好的格式。你將會在 Python
程式裡使用它們，而資料庫會將它們作為欄名稱。

你可以使用可選的選項來為 [`Field`{.xref .py .py-class .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/fields/#django.db.models.Field "django.db.models.Field")
定義一個人類可讀的名字。這個功能在很多 Django
內部組成部分中都被使用了，而且作為文件的一部分。如果某個欄位沒有提供此名稱，Django
將會使用對機器友好的名稱，也就是變數名稱。在上面的例子中，我們只為
`Question.pub_date`{.docutils .literal .notranslate}
定義了對人類友好的名字。對於模型內的其它欄位，它們的機器友好名稱也會被作為人類友好名稱使用。

定義某些 [`Field`{.xref .py .py-class .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/fields/#django.db.models.Field "django.db.models.Field")
類別實例需要參數。例如 [`CharField`{.xref .py .py-class .docutils
.literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/fields/#django.db.models.CharField "django.db.models.CharField")
需要一個 [`max_length`{.xref .py .py-attr .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/fields/#django.db.models.CharField.max_length "django.db.models.CharField.max_length")
參數。這個參數的用途不僅止於用來定義資料庫結構，也用於驗證資料，我們稍後將會看到這方面的內容。

[`Field`{.xref .py .py-class .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/fields/#django.db.models.Field "django.db.models.Field")
也能夠接收多個可選參數；在上面的例子中：我們將 `votes`{.docutils
.literal .notranslate} 的 [`default`{.xref .py .py-attr .docutils
.literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/fields/#django.db.models.Field.default "django.db.models.Field.default")
也就是預設值，設為0。

注意在最後，我們使用 [`ForeignKey`{.xref .py .py-class .docutils
.literal
...
定義了一個關聯。這將告訴 Django，每個 `Choice`{.docutils .literal
.notranslate} 物件都關聯到一個 `Question`{.docutils .literal
.notranslate} 物件。Django
...
-   為這個應用程式建立資料庫 schema（產生 `CREATE TABLE`{.docutils
    .literal .notranslate} 語句）。
-   建立可以與 `Question`{.docutils .literal .notranslate} 和
    `Choice`{.docutils .literal .notranslate} 物件進行交互的 Python
    資料庫 API。

但是首先得把 `polls`{.docutils .literal .notranslate}
應用程式安裝到我們的專案裡。
...
[`INSTALLED_APPS`{.xref .std .std-setting .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-INSTALLED_APPS)
中增加設定。因為 `PollsConfig`{.docutils .literal .notranslate}
類別寫在文件 `polls/apps.py`{.file .docutils .literal .notranslate}
中，所以它的點式路徑是 `'polls.apps.PollsConfig'`{.docutils .literal
.notranslate}。在文件 `mysite/settings.py`{.file .docutils .literal
.notranslate} 中 [`INSTALLED_APPS`{.xref .std .std-setting .docutils
.literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-INSTALLED_APPS)
子項增加點式路徑後，它看起來像這樣：
...
現在你的 Django 專案會包含 `polls`{.docutils .literal .notranslate}
應用程式。接著執行下面的命令：
...
透過執行 `makemigrations`{.docutils .literal .notranslate} 命令，Django
...
`polls/migrations/0001_initial.py`{.docutils .literal .notranslate}
裡。別擔心，你不需要每次都閱讀遷移文件，但是它們被設計成人類可讀的形式，這是為了便於你手動調整
Django 的修改方式。

Django 有一個自動執行資料庫遷移並同步管理你的資料庫結構的命令 -
這個命令是 [`migrate`{.xref .std .std-djadmin .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/django-admin/#django-admin-migrate)，我們馬上就會接觸它
- 但是首先，讓我們看看遷移命令會執行哪些 SQL 語句。[`sqlmigrate`{.xref
.std .std-djadmin .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/django-admin/#django-admin-sqlmigrate)
...
-   資料庫的表名稱是結合了應用程式名稱 (`polls`{.docutils .literal
    .notranslate}) 和資料庫模型的英文小寫名稱 – `question`{.docutils
    .literal .notranslate} 和 `choice`{.docutils .literal .notranslate}
    組合而成的。（如果需要，你可以覆寫這個定義。）
-   主鍵 (IDs) 會被自動建立。(你也可以覆寫這個定義。)
-   依照慣例，Django 會在外鍵欄位名稱後追加字串 `"_id"`{.docutils
    .literal .notranslate} 。（是，這個定義也可以覆寫。）
-   外鍵關聯由 `FOREIGN KEY`{.docutils .literal .notranslate}
    產生。你不用關心 `DEFERRABLE`{.docutils .literal .notranslate}
    部分，它只是告訴
    PostgreSQL，請在整個交易過程全部執行完之後再建立外鍵關聯。
-   產生的 SQL
    語句是使用你選用的資料庫客製化成的，所以那些和資料庫有關的欄位類型，例如
    `auto_increment`{.docutils .literal .notranslate} (MySQL)、
    `serial`{.docutils .literal .notranslate} (PostgreSQL)和
    `integer primary key autoincrement`{.docutils .literal .notranslate}
    (SQLite)，Django 會幫你自動處理。那些和引號相關的事情 –
    例如，是使用單引號還是雙引號 – 也一樣會被自動處理。
-   這個 [`sqlmigrate`{.xref .std .std-djadmin .docutils .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/django-admin/#django-admin-sqlmigrate)
    命令並沒有真正在你的資料庫中的執行遷移 -
...
如果你有興趣，你也可以試試看執行 [`python manage.py check`{.xref .std
.std-djadmin .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/django-admin/#django-admin-check)；這個命令協助你檢查專案中的問題，並且在檢查過程中不會對資料庫進行任何操作。

現在，再次執行 [`migrate`{.xref .std .std-djadmin .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/django-admin/#django-admin-migrate)
...
`django_migrations`{.docutils .literal .notranslate}
來追蹤執行過哪些遷移）並套用在資料庫上 -
...
-   編輯 `models.py`{.docutils .literal .notranslate} 文件，改變模型。
-   執行 [`python manage.py makemigrations`{.xref .std .std-djadmin
    .docutils .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/django-admin/#django-admin-makemigrations)
    為模型的改變產生遷移文件。
-   執行 [`python manage.py migrate`{.xref .std .std-djadmin .docutils
    .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/django-admin/#django-admin-migrate)
    來套用資料庫遷移。
...
，你可以取得關於 `manage.py`{.docutils .literal .notranslate}
工具的更多資訊。
...
我們改用這個命令而不是簡單的輸入 "Python" 是因為 `manage.py`{.file
.docutils .literal .notranslate} 會設定
`DJANGO_SETTINGS_MODULE`{.docutils .literal .notranslate}
環境變數，這個變數會讓 Django 根據 `mysite/settings.py`{.file .docutils
.literal .notranslate} 文件來設定 Python 套件的導入路徑。
...
等等。`<Question: Question object (1)>`{.docutils .literal .notranslate}
對於我們了解這個物件的細節沒什麼協助。讓我們透過編輯
`Question`{.docutils .literal .notranslate} 模型的程式（位於
`polls/models.py`{.docutils .literal .notranslate}
中）來修正這個問題。給 `Question`{.docutils .literal .notranslate} 和
`Choice`{.docutils .literal .notranslate} 增加 [`__str__()`{.xref .py
.py-meth .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/instances/#django.db.models.Model.__str__ "django.db.models.Model.__str__")
方法。
...
給模型增加 [`__str__()`{.xref .py .py-meth .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/instances/#django.db.models.Model.__str__ "django.db.models.Model.__str__")
...
新加入的 `import datetime`{.docutils .literal .notranslate} 和
`from django.utils import timezone`{.docutils .literal .notranslate}
分別導入了 Python 的標準 [`datetime`{.xref .py .py-mod .docutils
.literal
.notranslate}](https://docs.python.org/3/library/datetime.html#module-datetime "(在 Python v3.8)")
模組和 Django 中和時區相關的 [`django.utils.timezone`{.xref .py .py-mod
.docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/utils/#module-django.utils.timezone "django.utils.timezone: Timezone support.")
工具模組。如果你不太熟悉 Python 中的時區處理，看看
[時區支援文件](https://docs.djangoproject.com/zh-hans/3.0/topics/i18n/timezones/)
吧。

儲存文件然後透過 `python manage.py shell`{.docutils .literal
.notranslate} 命令再次打開 Python 交互式命令欄：
...
預設為打開狀態，因此如果您設定了 [`LANGUAGE_CODE`{.xref .std
.std-setting .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-LANGUAGE_CODE)，則登錄畫面將會以指定的語言顯示(如果
Django 有 適當的翻譯)。
...
只需要再做一件事：我們得告訴管理員，問題 `Question`{.docutils .literal
.notranslate} 物件需要一個管理接口。打開 `polls/admin.py`{.file
.docutils .literal .notranslate} 文件，把它編輯成下面這樣：
...
現在我們向管理頁面注冊了問題 `Question`{.docutils .literal .notranslate}
...
-   這個表單是從問題 `Question`{.docutils .literal .notranslate}
    模型中自動產生的
-   不同的欄位類型（日期時間欄位 [`DateTimeField`{.xref .py .py-class
    .docutils .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/fields/#django.db.models.DateTimeField "django.db.models.DateTimeField")
    、字串欄位 [`CharField`{.xref .py .py-class .docutils .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/fields/#django.db.models.CharField "django.db.models.CharField")）會產生對應的
    HTML 輸入控件。每個類型的欄位都知道它們該如何在管理頁面裡顯示自己。
-   每個日期時間欄位 [`DateTimeField`{.xref .py .py-class .docutils
    .literal
    .notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/models/fields/#django.db.models.DateTimeField "django.db.models.DateTimeField")
    都有 JavaScript
...
裡建立它們的時間不一致，這意味著你可能沒有正確的設定 [`TIME_ZONE`{.xref
.std .std-setting .docutils .literal
.notranslate}](https://docs.djangoproject.com/zh-hans/3.0/ref/settings/#std:setting-TIME_ZONE)
